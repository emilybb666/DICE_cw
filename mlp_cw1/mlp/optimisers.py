...
class Optimiser(object):
    ...
    def __init__(self, model, error, learning_rule, train_dataset,
                 valid_dataset=None, data_monitors=None, cosine_scheduler=None, notebook=False):
    ...
    def do_training_epoch(self, epoch):
        ...
        if self.cosine_scheduler == None :
            pass
        else :
            self.cosine_scheduler.update_learning_rule(self.learning_rule, epoch_number=epoch)
